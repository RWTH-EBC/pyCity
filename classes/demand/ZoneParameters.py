...
class ZoneParameters(object):
    ...
    def __init__(self, 
        ...
        ----------
        A_f : float
            Used floor area in m2 (cf. DIN EN ISO 13790, section 6.4, page 30)
        A_w : array_like
            Surface area of each window-like component (window, door,...) in m2
        U_w : array_like
            U-values for each window-like component (window, door,...) in W/m2K
        ...
        A_op : array_like
            Surface area of each opaque component (walls, roof) in m2
        U_op : array_like
            U-values for each opaque component (walls, roof) in W/m2K
        alpha_Sc : array_like
        ...
        kappa_j : array_like, optional
            ...
            air in J/m2K. Optional. Only used if ``simplifiedCapacity==False``
        A_j : array_like, optional
            Surface area of each component that is in contact with the indoor 
            air in m2. Optional. Only used if ``simplifiedCapacity==False``
        ...
        h_is = 3.45                     # m2, section 7.2.2.2, page 35
        lambda_at = 4.5                 # section 7.2.2.2, page 36
        self.A_t = A_f * lambda_at      # m2
