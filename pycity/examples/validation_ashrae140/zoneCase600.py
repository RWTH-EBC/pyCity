...
folder_inputs = "pycity/examples/validation_ashrae140/"
weather = pycity.classes.Weather.Weather(timer, 
                 pathTemperature=folder_inputs+"weather_temperature.csv", 
                 pathDirectRadiation=folder_inputs+"weather_beam.csv", 
                 pathDiffuseRadiation=folder_inputs+"weather_diffuse.csv", 
