# -*- coding: utf-8 -*-
"""
Created on Tue Feb 17 14:33:32 2015
...
apartment.addMultipleEntities([dhw, dishwasher, washingmachine, thermalload, electricalload])
...
tFlow = building.controller.getFlowTemperature(building.getApartment(-1))

(demandElectrical, demandThermal) = building.controller.getDemands(building.getApartment(-1))

print 
print "Electrical demand: " + str(demandElectrical)
print "Thermal demand: "    + str(demandThermal)